...
const Accessories = () => {
  ...
  const [accessories, setAccessories] = useState(
    products.filter((p) => p.type === "accessories")
  );
  ...
  const sortedA = [...accessories].sort(dateA);
  const sortedB = [...accessories].sort(dateB);
  ...
  useEffect(() => {
    if (option === "Price (asc)") {
      setAccessories(sortedA);
    } else if (option === "Price (desc)") {
      setAccessories(sortedB);
    } else {
